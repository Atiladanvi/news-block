<!--suppress CssUnusedSymbol, CssInvalidPropertyValue, CssInvalidFunction, CssUnknownProperty, CssRedundantUnit -->
<template>
  <b-container id="news-grid" class="my-4">
    <div class="col-lg-12">
      <div class="d-flex justify-content-center">
        <b-form-group>
          ...
          <b-form-radio-group
            ...
            size="md"
            class="d-none d-lg-block select-categories"
            v-model="selected"
            :options="categories"
          />
        </b-form-group>
            ...
            >
              <div class="card bg-dark text-white">
                ...
                <div class="card-img-overlay linkfeat d-flex">
                  ...
                  >
                    <h6 class="card-title text-white text-center small mb-1">{{ item.title }}</h6>
